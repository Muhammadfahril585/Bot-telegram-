...
async def daftar_halaqah(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message:
        # Kalau dipanggil dari command, balas biasa
        await update.message.reply_text(pesan, parse_mode="HTML")
    elif update.callback_query:
        # Kalau dipanggil dari tombol callback:
        await update.callback_query.answer()  # berikan feedback ke Telegram
        # Ganti pesan tombol dengan daftar halaqah
